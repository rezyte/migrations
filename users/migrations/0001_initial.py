# Generated by Django 2.2 on 2020-12-08 12:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('0', 'Seller'), ('1', 'Buyer'), ('2', 'Both')], max_length=12, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gender', models.CharField(choices=[('خانم', '0'), ('آقای', '1')], max_length=17, verbose_name='جنسیت')),
                ('profile_picture', models.ImageField(blank=True, default='images/documents/index.png', null=True, upload_to='', verbose_name='تصویر پروفایل')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postal_code', models.CharField(blank=True, max_length=12, null=True, verbose_name='کد پستی')),
                ...
                ('business_type', models.CharField(blank=True, choices=[('تولید کننده', ' 0'), ('پخش کننده', '1'), ('وارد کننده', '2'), ('خدمات', '3'), ('عمده فروش', '4'), ('بنک دار', '5'), ('دولتی', '6'), ('متفرقه', '7')], max_length=20, null=True, verbose_name='زمینه کاری')),
