...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('categories', '0002_auto_20201208_1416'),
        ('users', '0001_initial'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_image', models.ImageField(blank=True, null=True, upload_to=products.models.upload_to)),
                ...
                ('samples', models.CharField(blank=True, choices=[('0', 'No'), ('1', 'Free'), ('2', 'Charge Included')], max_length=24, null=True, verbose_name='ارائه نمونه')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(limit_choices_to={'model': 'productcomment'}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
